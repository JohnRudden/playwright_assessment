Feature: Navigate to a specific link from a Timeline Content Block
 ...
 #   And the user opens the <Menu> using a <inputDevice>
 #   And the user selects the <Menu Option> using a <inputDevice>
 ...
 #   Then the correct <web page> is launched in a new tab
      ...
      |Discovery Aids|The Browings:A Brief History|keyboard   |1845         |view one of the fist love letters|https://demo.quartexcollections.com/Documents/Detail/10-january-1845.-browning-robert-to-browning-elizabeth-barrett./36113|
